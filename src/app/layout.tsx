...
export const metadata: Metadata = {
  title: {
    default: "Dijital Güvenlik Uzmanı | Hesap Kurtarma ve Güvenlik Hizmetleri - Falcon Media",
    template: "%s | Falcon Media - Dijital Güvenlik Uzmanı",
  },
  description:
    "Dijital güvenlik uzmanı ekibimizle Instagram hesap kurtarma, Facebook hesap kurtarma, sosyal medya güvenliği ve hesap koruma hizmetleri. Siber güvenlik danışmanlığı ve 7/24 profesyonel destek. Tel: 0537 312 78 39",
  keywords: [
